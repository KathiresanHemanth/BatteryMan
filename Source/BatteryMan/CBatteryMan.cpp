...
void ACBatteryMan::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACBatteryMan::Look);

	}

}

void ACBatteryMan::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACBatteryMan::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
